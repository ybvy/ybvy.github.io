...
# II. Các thành phần của IP Header
## 1. Version
...
### 2.1. Công thức tính kích thước Header
{% highlight bash %}
length(header) = IHL * 4
...
### 4.1 Công thức tính kích thước Total Length
{% highlight bash %}
...
### 7.3. Giá trị TTL phổ biến theo hệ điều hành
...
### 8.1. Một số giá trị phổ biến của Protocol
